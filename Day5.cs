...
namespace adventOfCode2023
{
    class FarmMap
    {
        ...
        public FarmMap(String line)
        {
            ...
            this.destStart = Int64.Parse(strs[0]);
            this.sourceStart = Int64.Parse(strs[1]);
            long range = Int64.Parse(strs[2]);
    ...
    class Day5
    {
        static String testSeedsIn = "79 14 55 13";
        static String[] testSeedToSoilIn = {
            "50 98 2",
            "52 50 48"
        };
        static String[] testSoilToFertilizerIn = {
            "0 15 37",
            "37 52 2",
            "39 0 15"
        };
        static String[] testFertilizerToWaterIn = {
            "49 53 8",
            "0 11 42",
            "42 0 7",
            "57 7 4"
        };
        static String[] testWaterToLightIn = {
            "88 18 7",
            "18 25 70"
        };
        static String[] testLightToTemperatureIn = {
            "45 77 23",
            "81 45 19",
            "68 64 13"
        };
        static String[] testTemperatureToHumidityIn = {
            "0 69 1",
            "1 0 69"
        };
        static String[] testHumidityToLocationIn = {
            "60 56 37",
            "56 93 4"
        };

        static String actualSeedsIn = "4188359137 37519573 3736161691 172346126 2590035450 66446591 209124047 106578880 1404892542 30069991 3014689843 117426545 2169439765 226325492 1511958436 177344330 1822605035 51025110 382778843 823998526";
        static String[] actualSeedToSoilIn = {
        ...
        static String[] actualSoilToFertilizerIn = {
        ...
        static String[] actualFertilizerToWaterIn = {
        ...
        static String[] actualWaterToLightIn = {
        ...
        static String[] actualLightToTemperatureIn = {
        ...
        static String[] actualTemperatureToHumidityIn = {
        ...
        static String[] actualHumidityToLocationIn = {
        ...
        public static long DoMapping(List<FarmMap> maps, long source)
        {
            long dest = -1;
            foreach (FarmMap map in maps)
            {
                if (map.Map(source) != -1)
                {
                    dest = map.Map(source);
        ...
        public static long CalcMinLocation(
            String seeds,
            String[] seedToSoil,
            String[] soilToFertilizer,
            String[] fertilzerToWater,
            String[] waterToLight,
            ...
            String[] humidityToLocation)
        {
            ...
            foreach (String str in seeds.Split()) {
                seedsInt.Add(Int64.Parse(str));
            }
            List<FarmMap> seedToSoilMap = new List<FarmMap>();
            foreach (String str in seedToSoil)
            {
                seedToSoilMap.Add(new FarmMap(str));
            }
            List<FarmMap> soilToFertilizerMap = new List<FarmMap>();
            foreach (String str in soilToFertilizer)
            {
                soilToFertilizerMap.Add(new FarmMap(str));
            }
            List<FarmMap> fertilizerToWaterMap = new List<FarmMap>();
            foreach (String str in fertilzerToWater)
            {
                fertilizerToWaterMap.Add(new FarmMap(str));
            }
            List<FarmMap> waterToLightMap = new List<FarmMap>();
            foreach (String str in waterToLight)
            {
                waterToLightMap.Add(new FarmMap(str));
            }
            List<FarmMap> lightToTemperatureMap = new List<FarmMap>();
            foreach (String str in lightToTemperature)
            {
                lightToTemperatureMap.Add(new FarmMap(str));
            }
            List<FarmMap> temperatureToHumidityMap = new List<FarmMap>();
            foreach (String str in temperatureToHumidity)
            {
                temperatureToHumidityMap.Add(new FarmMap(str));
            }
            List<FarmMap> humidityToLocationMap = new List<FarmMap>();
            foreach (String str in humidityToLocation)
            {
                humidityToLocationMap.Add(new FarmMap(str));
            }

            long minLocation = Int64.MaxValue;
            foreach (long seed in seedsInt)
            {
                long soilVal = DoMapping(seedToSoilMap, seed);
                long fertilizerVal = DoMapping(soilToFertilizerMap, soilVal);
                long waterVal = DoMapping(fertilizerToWaterMap, fertilizerVal);
                long lightVal = DoMapping(waterToLightMap, waterVal);
                long temperatureVal = DoMapping(lightToTemperatureMap, lightVal);
                long humidityVal = DoMapping(temperatureToHumidityMap, temperatureVal);
                long locationVal = DoMapping(humidityToLocationMap, humidityVal);
                if (locationVal < minLocation)
                {
                    minLocation = locationVal;
                }
            }
            return minLocation;
        }

        public static long CalcMinLocationSeedRange(
            String seeds,
            String[] seedToSoil,
            String[] soilToFertilizer,
            String[] fertilzerToWater,
            ...
            String[] humidityToLocation)
        {
            ...
            for (int i = 0; i < seedsInt.Count; i += 2)
            {
                for (long j = seedsInt[i]; j < seedsInt[i] + seedsInt[i+1]; ++j)
                {
                    seedsRanged.Add(j);
                }
            }
            ...
            long minLocation = Int64.MaxValue;
            foreach (long seed in seedsRanged)
            {
                long soilVal = DoMapping(seedToSoilMap, seed);
                long fertilizerVal = DoMapping(soilToFertilizerMap, soilVal);
                long waterVal = DoMapping(fertilizerToWaterMap, fertilizerVal);
        ...
        public static void Part1()
        {
            if (CalcMinLocation(
                testSeedsIn,
                testSeedToSoilIn,
                testSoilToFertilizerIn,
                testFertilizerToWaterIn,
                testWaterToLightIn,
                testLightToTemperatureIn,
                testTemperatureToHumidityIn,
                testHumidityToLocationIn) != 35)
            {
            ...
            Console.WriteLine("Part1 min location: " +
                CalcMinLocation(
                    actualSeedsIn,
                    actualSeedToSoilIn,
                    actualSoilToFertilizerIn,
                    actualFertilizerToWaterIn,
                    actualWaterToLightIn,
                    actualLightToTemperatureIn,
                    actualTemperatureToHumidityIn,
                    actualHumidityToLocationIn));
        }

        public static void Part2()
        {
            if (CalcMinLocationSeedRange(
                testSeedsIn,
                testSeedToSoilIn,
                testSoilToFertilizerIn,
                testFertilizerToWaterIn,
            ...
            Console.WriteLine("Part2 min location: " +
                CalcMinLocationSeedRange(
                    actualSeedsIn,
                    actualSeedToSoilIn,
                    actualSoilToFertilizerIn,
                    actualFertilizerToWaterIn,
